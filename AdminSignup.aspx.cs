    ...
    public partial class AdminSignup : System.Web.UI.Page
    {
        ...
        void checkEmployeeID()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("select *from adminRegister where employeeID='" + TextBox1.Text.Trim() + "' ", con);
                ...
                {
                    Response.Write("<script>alert('Your not a chef');</script>");
                }
            }
            catch (Exception ex)
            {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                Response.Write("<script>alert('Admin not added successfully');</script>");
